...
enum class StructureProfile(
    ...
    VOID(
        ...
        isElongated = false,
        recommendedFilters = listOf(FilterType.CONSENSUS_SCORE, FilterType.RX_MULTIBAND_LOCAL, FilterType.STANDARD_DEVIATION, FilterType.GLCM_CONTRAST, FilterType.LAYER_MEDIUM, FilterType.MULTISCALE_BLOB, FilterType.RX_MULTIBAND_GLOBAL, FilterType.ANOMALY_ENHANCEMENT, FilterType.BAND_PASS)
    ),
    ENTRANCE(
        label = "Giriş",
        typicalSizeMeters = 1.5,
